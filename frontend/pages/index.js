...
function DatasetDownloader(props) {
    ...
    return (
        ...
        <Layout>
            ...
            <Container>
            <p>If you don't see any mooclet, please visit this to sign up first: https://mooclet-dashboard.adexacc.org/apis/signUpMOOCletToken/Token%(replace this with actually token)</p>
            <TextField
                    required
                    id="email-input"
                    label="Your email"
